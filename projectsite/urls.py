...
from cardquest.views import HomePageView, TrainerList, PokemonCard, Collection, TrainerCreateView, TrainerUpdateView, TrainerDeleteView
...
urlpatterns = [
    ...
    path('pokemon-cards', PokemonCard.as_view(), name='pokemon-cards'),
